        ...
        implements TrinoCatalog
{
    ...
    {
        return ImmutableMap.copyOf(sessionCatalog.loadNamespaceMetadata(convert(session), Namespace.of(namespace)));
    }
    ...
    {
        checkArgument(!properties.containsKey(LOCATION_PROPERTY), "Database cannot be created with a location set");
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "setTablePrincipal is not supported for Iceberg REST catalogs");
    }
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "renameView is not supported for Iceberg REST catalogs");
    }

    @Override
    public void setViewPrincipal(ConnectorSession session, SchemaTableName schemaViewName, TrinoPrincipal principal)
    {
        throw new TrinoException(NOT_SUPPORTED, "setViewPrincipal is not supported for Iceberg REST catalogs");
    }

    @Override
    public void dropView(ConnectorSession session, SchemaTableName schemaViewName)
    {
        throw new TrinoException(NOT_SUPPORTED, "dropView is not supported for Iceberg REST catalogs");
    }
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "dropMaterializedView is not supported for Iceberg REST catalogs");
    }
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "renameMaterializedView is not supported for Iceberg REST catalogs");
    }
    ...
    {
        throw new TrinoException(NOT_SUPPORTED, "updateViewComment is not supported for Iceberg REST catalogs");
    }
